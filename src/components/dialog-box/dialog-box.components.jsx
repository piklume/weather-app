...
import { selectWeatherValues } from '../../redux/country/country.selector';
...
export function CustomizedDialogs({ open,handleClose,fetchWeatherStart,weatherValues }) {
